...
export const GridScan: React.FC<GridScanProps> = ({
    ...
    }, [sensitivity, lineThickness, linesColor, scanColor, scanOpacity, gridScale, enablePost, noiseIntensity, bloomIntensity, chromaticAberration, smoothTime, maxSpeed, skewScale, yBoost, tiltScale, yawScale]);
    ...
    }, [lineThickness, linesColor, scanColor, gridScale, bloomIntensity, noiseIntensity, scanOpacity, chromaticAberration]);
